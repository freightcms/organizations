module github.com/squishedfox/organization-webservice/db/mongodb

go 1.22.5

require (
	github.com/squishedfox/organization-webservice/db v0.0.0-20240903022458-8a0aaf3e37f6
	github.com/squishedfox/organization-webservice/models v0.0.0-20240903022458-8a0aaf3e37f6
