...
type OrganizationResourceManager interface {
	...
	CreateOrganization(model *models.Organization) (any, error)
	...
	DeleteOrganization(id any) error
	...
	UpdateOrganization(id any, model *models.Organization) error
	...
	GetById(id any) (*models.Organization, error)
	...
	Get(query *OrganizationQuery) ([]*models.Organization, int64, error)
